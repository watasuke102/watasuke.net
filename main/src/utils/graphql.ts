...
export type AllQuery = {
  ...
  allTags: Array<{__typename?: 'Tag'; slug: string; name: string}>;
  sitedata: {__typename?: 'Sitedata'; profile: string; shortProfile: string};
};
    ...
    all(variables?: AllQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<AllQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<AllQuery>(AllDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}),
        'all',
        'query',
        variables,
      );
